export const skillCategories = [
    {
        ...
        skills: [
            ...
            { name: "Framer Motion", level: "Mahir", description: "Animasi transisi halus dan interaksi mikro interaktif", icon: "Sparkles", color: "from-purple-500 to-pink-500" },
            { name: "HTML5 & CSS3", level: "Sangat Mahir", description: "Struktur semantik ramah aksesibilitas & styling modern", icon: "Globe", color: "from-orange-500 to-red-500" },
            { name: "Redux / Zustand", level: "Mahir", description: "Manajemen global state yang ringan dan terstruktur", icon: "Workflow", color: "from-violet-500 to-purple-600" },
        ],
    },
    {
        id: "backend",
        title: "Backend & Database",
        description: "Membangun API, autentikasi aman, dan manajemen data",
        skills: [
            { name: "Node.js", level: "Mahir", description: "Runtime JavaScript server-side untuk layanan performa tinggi", icon: "Server", color: "from-emerald-500 to-green-600" },
            { name: "Express.js", level: "Mahir", description: "Framework backend fleksibel untuk routing & middleware", icon: "Cpu", color: "from-slate-300 to-slate-500" },
            { name: "RESTful API", level: "Sangat Mahir", description: "Desain endpoint terstruktur, autentikasi JWT, dan validasi data", icon: "Network", color: "from-sky-500 to-blue-600" },
            { name: "PostgreSQL", level: "Menengah", description: "Database relasional SQL, relasi tabel, dan indexing", icon: "Database", color: "from-blue-400 to-indigo-500" },
            { name: "MongoDB", level: "Mahir", description: "Database NoSQL berbasis dokumen dan agregasi data", icon: "DatabaseZap", color: "from-emerald-400 to-green-500" },
            { name: "Prisma ORM", level: "Mahir", description: "Type-safe database querying, migrasi skema, dan relasi", icon: "Box", color: "from-slate-200 to-slate-400" },
        ],
    },
    {
        id: "tools",
        ...
        skills: [
            ...
            { name: "Docker (Dasar)", level: "Menengah", description: "Kontainerisasi aplikasi untuk konsistensi lingkungan dev", icon: "Container", color: "from-cyan-400 to-blue-500" },
        ],
    },
];
